...
def em_step(vc, tv, tc):
    ...
    print(len_voc)
    print(len_coll)
    # twd = np.random.uniform(0, 5, size=([len_voc, len_coll]))
    ...
    for iteration in range(1, 21):
        ...
        np.savetxt('plsa_tv_K8_' + str(iteration), new_tv, delimiter=',')
        np.savetxt('plsa_tc_K8_' + str(iteration), new_tc, delimiter=',')
